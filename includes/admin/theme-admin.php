		...
		<div class="welcome_halfed">
			<div class="welcome_left">
				...
				<div class="container">
					...
					<p><?php _e('The <b>PRO Version</b> provide additional custom widgets and an author box.', 'themezee_lang'); ?></p>
					<p><h4>Pro Widgets:</h4>
						<ul>
							<li>+ Recent Posts Widget (with thumbnails)</li>
							<li>+ Tabbed Widget (can show 8 different content types)</li>
							<li>+ Recent Comments Widget</li>
							<li>+ Popular Posts Widget (with thumbnails)</li>
						</ul>
